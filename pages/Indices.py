...
if 'BANCOS' == 'BANCOS':
        ...
        cursor = conn.cursor()
st.header('Visualização de :blue[Indices]!',divider='blue')  
...
if oimaioa == "O.S de manutenção":
        def gerar_datas_seguidas(data_inicial1,numero_de_datas,banco_de_dados1,numero_de_dias):
            ...
            if banco_de_dados1 == 'Geral':
                ...
                Elétcia_dataframes = [numero1, numero3, numero5, numero7,numero9,numero11,numero13,numero15,numero17,numero19,numero21,numero23,numero25,numero27,numero29,numero31,numero33,numero35,numero37,numero39,numero41,numero43,numero45,numero47,numero49,numero51,numero53,numero55,numero57,numero69]

                if numero_de_dias == 5:
                        OS_semanais_Elétcia = numero2 + numero4 + numero6 + numero8 + numero10
                if numero_de_dias == 30:
                        OS_semanais_Elétcia = 
                ...
                OS_totais = OS_semanais_administraivo + OS_semanais_Comercial + OS_semanais_Elétcia + OS_semanais_Mecânica + OS_semanais_Expedição + OS_semanais_Ferramentaria + OS_semanais_Produção + OS_semanais_Serralharia + OS_semanais_TI
        
            return datas_geradas,OS_semanais_Elétcia,OS_semanais_Ferramentaria,OS_semanais_Produção,OS_semanais_administraivo,OS_semanais_Comercial,OS_semanais_Expedição,OS_semanais_Serralharia,OS_semanais_TI,OS_totais,DBx,OS_semanais_Mecânica,Elétcia_dataframes,Mecânica_dataframes,Produção_dataframes,Administrativo_dataframes,Comercial_dataframes,Expedição_dataframes,Serralharia_dataframes,ti_dataframes,Ferramentaria_dataframes
        
        datas_geradas = gerar_datas_seguidas(data_inicial1,numero_de_datas,banco_de_dados1,numero_de_dias)
        nmr = datas_geradas[10]
        st.metric(f'{texto}',value=datas_geradas[nmr])

        source = pd.DataFrame({
        'Setores': ['Produção','Ferramentaria', 'Administrativo', 'Comercial', 'Serralharia', 'Elétcia', 'Mecânica','Expedição','T.I'],
        ...
        if numero_de_dias == 5:
                with st.expander(datas_geradas[0][0]):
                        tab,tab1,tab2,tab3,tab4,tab5,tab6,tab7,tab8 = st.tabs(['Elétcia','Mecânica','Produção','Administrativo','Comercial','Expedição','Serralharia','T.I','Ferramentaria'])
                        with tab:
