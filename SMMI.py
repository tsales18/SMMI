            ...
            with tab1:
                ...
                with colibrim:
                    with st.form('my form2'):
                        ...
                        solicitante = st.selectbox(st.write('Solicitante'), ('FILIPE','JAMESON','MAURILIO SALES','BRUNO KAPPAUN','EDUARDO BICUDO','ADRIELY LEMOS','GILSON FREITAS','ALEX SANTOS','CESAR AUGUSTO'),index=None,placeholder='Selecione')
                        if atd:
