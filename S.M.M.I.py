                ...
                with neymar:
                    if atd1:
                        ...
                        if allln1 == 0:
                            ...
                            numero_da_os = st.number_input("Selecione o numero da O.S que deseja DELETAR",min_value=1,max_value=allln1,value=int(preenchimento[0]),placeholder="Selecione")
